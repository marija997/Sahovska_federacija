...
{
    public partial class IzaberiOrganizatora : Form
    {
        ...
        public IzaberiOrganizatora()
        {
            InitializeComponent();
        }
        public IzaberiOrganizatora(TurnirBasic sb)
        {
            this.tBasic = sb;
            InitializeComponent();
        }

        private void IzaberiOrganizatora_Load(object sender, EventArgs e)
        {
